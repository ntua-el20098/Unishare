...
final parametersBuilderMap =
  ...
  'UserHomePageSolved': ParameterData.none(),
  'UserProfile': ParameterData.none(),
  'UserRewards': ParameterData.none(),
  'UserPageUnsolved': ParameterData.none(),
  'camera': ParameterData.none(),
  'adminHomePage': (data) async => ParameterData(
        allParams: {
  ...
  'AdminHistoryPage': ParameterData.none(),
  'cameraAdmin': (data) async => ParameterData(
        allParams: {
